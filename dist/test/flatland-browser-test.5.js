...
jQuery(function($) {
  'use strict';
  test('The El class (browser)', function() {});
});
if ('function' != typeof jQuery)
  throw Error('jQuery not found');
jQuery(function($) {
  'use strict';
  test('The El.Cutout class (browser)', function() {
...
jQuery(function($) {
  'use strict';
  test('The El.Light class (browser)', function() {
...
jQuery(function($) {
  'use strict';
  test('The El.Light.Ambient class (browser)', function() {
